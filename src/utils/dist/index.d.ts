declare interface AbrComponentAPI extends ComponentAPI {
...
declare type AudioPlaylistType = 'AUDIO';
...
declare interface AudioTrackLoadedData extends TrackLoadedData {
}

declare interface AudioTracksUpdatedData {
    audioTracks: MediaPlaylist[];
}

declare interface AudioTrackSwitchedData extends MediaPlaylist {
}

declare interface AudioTrackSwitchingData extends MediaPlaylist {
}

declare interface BackBufferData {
    bufferEnd: number;
}
...
declare interface BufferAppendedData {
...
declare interface BufferAppendingData {
    type: SourceBufferName;
    frag: Fragment;
    part: Part | null;
    chunkMeta: ChunkMetadata;
...
declare interface BufferCodecsData {
    video?: Track;
    audio?: Track;
}
...
declare type BufferControllerConfig = {
...
declare interface BufferCreatedData {
    tracks: TrackSet;
}

declare interface BufferEOSData {
    type?: SourceBufferName;
}

declare interface BufferFlushedData {
    type: SourceBufferName;
}

declare interface BufferFlushingData {
    startOffset: number;
    endOffset: number;
...
declare type CMCDControllerConfig = {
    sessionId?: string;
    contentId?: string;
    useHeaders?: boolean;
};
...
declare class ContentSteeringController implements NetworkComponentAPI {
...
declare type ContentSteeringOptions = {
    uri: string;
    pathwayId: string;
};

declare interface CuesInterface {
    newCue(track: TextTrack | null, startTime: number, endTime: number, captionScreen: CaptionScreen): VTTCue[];
}

declare interface CuesParsedData {
...
declare type DRMSystemsConfiguration = Partial<Record<KeySystems, DRMSystemConfiguration>>;

declare interface ElementaryStreamInfo {
    startPTS: number;
    endPTS: number;
    startDTS: number;
    endDTS: number;
...
declare type ElementaryStreams = Record<ElementaryStreamTypes, ElementaryStreamInfo | null>;

declare const enum ElementaryStreamTypes {
    AUDIO = "audio",
    VIDEO = "video",
...
declare type EMEControllerConfig = {
...
declare const enum ErrorActionFlags {
    None = 0,
...
declare class ErrorController implements NetworkComponentAPI {
    private readonly hls;
...
declare interface FPSDropData {
    currentDropped: number;
    currentDecoded: number;
    totalDroppedFrames: number;
}

declare interface FPSDropLevelCappingData {
    droppedLevel: number;
    level: number;
}

declare interface FragBufferedData {
    stats: LoadStats;
    frag: Fragment;
    part: Part | null;
    id: string;
...
declare interface FragChangedData {
    frag: Fragment;
}

declare interface FragDecryptedData {
    frag: Fragment;
    payload: ArrayBuffer;
    stats: {
        tstart: number;
...
declare interface FragLoadedData {
    frag: Fragment;
    part: Part | null;
    payload: ArrayBuffer;
...
declare interface FragLoadEmergencyAbortedData {
    frag: Fragment;
    part: Part | null;
    stats: LoaderStats;
}
...
declare interface FragLoadingData {
    frag: Fragment;
    part?: Part;
 ...
 */
declare class Fragment extends BaseSegment {
...
declare interface FragmentLoaderConstructor {
    new (confg: HlsConfig): Loader<FragmentLoaderContext>;
}

declare interface FragmentLoaderContext extends LoaderContext {
    frag: Fragment;
    part: Part | null;
    resetIV?: boolean;
}
...
declare interface FragParsedData {
    frag: Fragment;
    part: Part | null;
}

declare interface FragParsingInitSegmentData {
}

declare interface FragParsingMetadataData {
    id: string;
    frag: Fragment;
...
declare interface FragParsingUserdataData {
    id: string;
    frag: Fragment;
    details: LevelDetails;
...
declare type HdcpLevel = (typeof HdcpLevels)[number];
...
declare interface HlsChunkPerformanceTiming extends HlsPerformanceTiming {
    executeStart: number;
    executeEnd: number;
}

declare type HlsConfig = {
 ...
 */
declare interface HlsListeners {
...
declare interface HlsPerformanceTiming {
    start: number;
    end: number;
}

declare interface HlsProgressivePerformanceTiming extends HlsPerformanceTiming {
    first: number;
}

declare const enum HlsSkip {
    No = "",
    Yes = "YES",
    v2 = "v2"
}

declare class HlsUrlParameters {
    msn?: number;
    part?: number;
    skip?: HlsSkip;
...
declare interface InitPTSFoundData {
    id: string;
    frag: Fragment;
    initPTS: number;
    timescale: number;
...
declare interface KeyLoadedData {
    frag: Fragment;
...
declare interface KeyLoadingData {
    frag: Fragment;
}

declare const enum KeySystemFormats {
...
declare type LatencyControllerConfig = {
...
declare interface LevelAttributes extends AttrList {
    'ALLOWED-CPC'?: string;
    AUDIO?: string;
...
declare class LevelKey implements DecryptData {
    readonly uri: string;
...
declare interface LevelLoadedData {
    details: LevelDetails;
    id: number;
    level: number;
    networkDetails: any;
...
declare interface LevelLoadingData {
    id: number;
    level: number;
    url: string;
    deliveryDirectives: HlsUrlParameters | null;
...
declare interface LevelPTSUpdatedData {
    details: LevelDetails;
    level: Level;
    drift: number;
    type: string;
...
declare interface LevelsUpdatedData {
    levels: Array<Level>;
}

declare interface LevelSwitchedData {
    level: number;
}

declare interface LevelSwitchingData extends Omit<Level, '_urlId'> {
    level: number;
}

declare interface LevelUpdatedData {
    details: LevelDetails;
    level: number;
}
 ...
 */
declare interface LiveBackBufferData extends BackBufferData {
}

declare interface Loader<T extends LoaderContext> {
    destroy(): void;
    abort(): void;
...
declare interface LoaderCallbacks<T extends LoaderContext> {
...
declare interface LoaderConfiguration {
...
declare type LoaderOnAbort<T extends LoaderContext> = (stats: LoaderStats, context: T, networkDetails: any) => void;
...
declare type LoaderOnTimeout<T extends LoaderContext> = (stats: LoaderStats, context: T, networkDetails: any) => void;

declare interface LoaderResponse {
    url: string;
...
declare type LoadPolicy = {
    default: LoaderConfig;
};

declare class LoadStats implements LoaderStats {
    aborted: boolean;
    loaded: number;
    retry: number;
    total: number;
...
declare type MainPlaylistType = AudioPlaylistType | 'VIDEO';

declare interface ManifestLoadedData {
    audioTracks: MediaPlaylist[];
...
declare interface ManifestLoadingData {
    url: string;
}

declare interface ManifestParsedData {
    levels: Level[];
    audioTracks: MediaPlaylist[];
...
declare interface MediaAttachedData {
    media: HTMLMediaElement;
    mediaSource?: MediaSource;
}

declare interface MediaAttachingData {
    media: HTMLMediaElement;
}

declare interface MediaAttributes extends AttrList {
...
declare type MediaDecodingInfo = {
    supported: boolean;
...
declare type MediaKeyFunc = (keySystem: KeySystems, supportedConfigurations: MediaKeySystemConfiguration[]) => Promise<MediaKeySystemAccess>;

declare interface MediaKeySessionContext {
...
declare interface MediaPlaylist extends Omit<LevelParsed, 'attrs'> {
...
declare type MediaPlaylistType = MainPlaylistType | SubtitlePlaylistType;
...
declare interface MetadataSample {
    pts: number;
    dts: number;
    duration: number;
    len?: number;
...
declare const enum MetadataSchema {
    audioId3 = "org.id3",
...
declare const enum NetworkErrorAction {
    DoNothing = 0,
    SendEndCallback = 1,
...
declare interface NonNativeTextTrack {
    _id?: string;
    label: any;
    kind: string;
    default: boolean;
...
declare interface NonNativeTextTracksData {
 ...
 */
declare class Part extends BaseSegment {
...
declare const enum PlaylistContextType {
    MANIFEST = "manifest",
    LEVEL = "level",
...
declare const enum PlaylistLevelType {
    MAIN = "main",
    AUDIO = "audio",
    SUBTITLE = "subtitle"
}
...
declare interface PlaylistLoaderConstructor {
    new (confg: HlsConfig): Loader<PlaylistLoaderContext>;
}

declare interface PlaylistLoaderContext extends LoaderContext {
...
declare type SourceBufferName = 'video' | 'audio' | 'audiovideo';

declare type SourceBuffers = Partial<Record<SourceBufferName, ExtendedSourceBuffer>>;

declare type SteeringManifest = {
    VERSION: 1;
    TTL: number;
    'RELOAD-URI'?: string;
...
declare interface SubtitleFragProcessedData {
    success: boolean;
    frag: Fragment;
    error?: Error;
}

declare type SubtitlePlaylistType = 'SUBTITLES' | 'CLOSED-CAPTIONS';
...
declare interface SubtitleTrackLoadedData extends TrackLoadedData {
}
...
declare interface SubtitleTrackSwitchData {
    id: number;
    name?: string;
    groupId?: string;
    type?: MediaPlaylistType | 'main';
...
declare interface TrackLoadedData {
    details: LevelDetails;
    id: number;
    groupId: string;
    networkDetails: any;
...
declare interface TrackLoadingData {
    id: number;
    groupId: string;
    url: string;
    deliveryDirectives: HlsUrlParameters | null;
...
declare interface UserdataSample {
    pts: number;
    bytes?: Uint8Array;
    type?: number;
    payloadType?: number;
...
declare type VariableMap = Record<string, string>;
...
export { AUDIO_EVENTS, AUDIO_STATE, AUDIO_X_CONSTANTS, type AudioError, type AudioEvents, type AudioInit, type AudioState, AudioX, type ErrorEvents, type EventListenerCallbackMap, type EventListenersList, type InitMode, type MediaArtwork, type MediaTrack, type NetworkState, type PlayBackState, type PlaybackRate, type ReadyState };
